# Generated by Django 3.2 on 2023-05-23 12:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Пользователь'), ('moderator', 'Модератор'), ('admin', 'Администратор')], default='user', max_length=50, verbose_name='Пользовательская роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, 'Приемлемые значения от 1 до 10'), django.core.validators.MaxValueValidator(10, 'Приемлимые значения от 1 до 10')], verbose_name='Рейтинг')),
